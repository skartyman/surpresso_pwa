...
export function getAdminSections(t) {
  return [
  {
    ...
    items: [
      ...
      { key: 'clients', to: 'clients', icon: 'clients', label: t('nav_clients'), roles: [ROLES.manager, ROLES.serviceEngineer, ROLES.serviceHead, ROLES.salesManager, ROLES.director, ROLES.owner] },
...
export const PAGE_PERMISSIONS = {
  ...
  clients: [ROLES.manager, ROLES.serviceEngineer, ROLES.serviceHead, ROLES.salesManager, ROLES.director, ROLES.owner],
